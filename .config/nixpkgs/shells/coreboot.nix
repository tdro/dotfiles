let
  ...
  dependencies = { fetchurl }: [
    ...
    rec { name = "binutils-2.35.1.tar.xz";              archive = fetchurl { sha256 = "01w6xvfy7sjpw8j08k111bnkl27j760bdsi0wjvq44ghkgdr3v9w"; url = "https://ftpmirror.gnu.org/binutils/${name}";                                    }; }
    rec { name = "clang-11.0.0.src.tar.xz";             archive = fetchurl { sha256 = "091bvcny2lh32zy8f3m9viayyhb2zannrndni7325rl85cwgr6pr"; url = "https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.0/${name}"; }; }
    rec { name = "clang-tools-extra-11.0.0.src.tar.xz"; archive = fetchurl { sha256 = "02bcwwn54661madhq4nxc069s7p7pj5gpqi8ww50w3anbpviilzy"; url = "https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.0/${name}"; }; }
    ...
    rec { name = "compiler-rt-10.0.1.src.tar.xz";       archive = fetchurl { sha256 = "1yjqjri753w0fzmxcyz687nvd97sbc9rsqrxzpq720na47hwh3fr"; url = "https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.0/${name}"; }; }
    ...
    rec { name = "llvm-11.0.0.src.tar.xz";              archive = fetchurl { sha256 = "1wydhbp9kyjp5y0rc627imxgkgqiv3dfirbqil9dgpnbaw5y7n65"; url = "https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.0/${name}"; }; }
    ...
    rec { name = "nasm-2.15.05.tar.bz2";                archive = fetchurl { sha256 = "1l1gxs5ncdbgz91lsl4y7w5aapask3w02q9inayb2m5bwlwq6jrw"; url = "https://www.nasm.us/pub/nasm/releasebuilds/2.15.05/${name}";                    }; }
  ];
