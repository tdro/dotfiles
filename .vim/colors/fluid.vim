...
let  s:t_darkblue    =  '25'    |  let  s:g_darkblue    =  '#82B1FF'
let  s:t_orange      =  '208'   |  let  s:g_orange      =  '#e84f4f'
let  s:t_green       =  '148'   |  let  s:g_green       =  '#a6e22e'
let  s:t_darkgreen   =  '22'    |  let  s:g_darkgreen   =  '#a6e22e'
let  s:t_purple      =  '141'   |  let  s:g_purple      =  '#ae81ff'
let  s:t_darkpurple  =  '99'    |  let  s:g_darkpurple  =  '#ae81ff'
let  s:t_grey        =  '237'   |  let  s:g_grey        =  '#383d4d'
let  s:t_grey1       =  '238'   |  let  s:g_grey1       =  '#383d4d'
let  s:t_grey2       =  '239'   |  let  s:g_grey2       =  '#383d4d'
